...
if($statement->execute())
{
	...
	foreach($result as $row)
	{
		...
		<div class="col-md-2" style="margin-top:10px;">  
            <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:5px; height:200px;" align="center">
            	<span class="'.$row["image"].'"/></span><br />
            	<h4 class="text-info">'.$row["name"].'</h4>
            	<h4 class="text-danger">GEM '.$row["price"] .'</h4>
